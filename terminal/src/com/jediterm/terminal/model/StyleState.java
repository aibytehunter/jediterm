...
public class StyleState {
    ...
    private static TextStyle merge(@NotNull TextStyle style, @NotNull TextStyle defaultStyle) {
        ...
        if (style.getPromptBackground() == null && defaultStyle.getPromptBackground() != null) {
            builder.setPromptBackground(defaultStyle.getPromptBackground());
        }
    ...
    public TerminalColor getForeground(TerminalColor color) {
        return color != null ? color : myDefaultStyle.getPromptBackground();
    }
