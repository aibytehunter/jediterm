...
public class TextStyle {
    ...
    private final TerminalColor myPromptBackground;
    ...
    public TextStyle(@Nullable TerminalColor foreground, @Nullable TerminalColor background, @NotNull EnumSet<Option> options) {
        ...
        //提示背景
        myPromptBackground = new TerminalColor(123, 123, 123);
    ...
    public TerminalColor getPromptBackground() {
        return myPromptBackground;
    }
    ...
    public static class Builder {
        ...
        private TerminalColor myPromptBackground;
        ...
        public Builder(@NotNull TextStyle textStyle) {
            ...
            myPromptBackground = textStyle.myPromptBackground;
        ...
        @NotNull
        public Builder setPromptBackground(@Nullable TerminalColor myPromptBackground) {
            this.myPromptBackground = myPromptBackground;
            return this;
        }
