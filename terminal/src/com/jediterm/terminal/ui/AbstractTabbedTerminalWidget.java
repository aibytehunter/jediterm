...
public abstract class AbstractTabbedTerminalWidget<T extends JediTermWidget> extends JPanel implements TerminalWidget, TerminalActionProvider {
    ...
    public AbstractTabbedTerminalWidget(@NotNull TabbedSettingsProvider settingsProvider,
                                        @NotNull Function<AbstractTabbedTerminalWidget<T>, T> createNewSessionAction) {
...
//      label.setBorder(BorderFactory.createEmptyBorder(0, 0, 0, 5));
    ...
    public JComponent getFocusableComponent() {
        return myTabs != null ? myTabs.getComponent() : this;
    }
